        ...
        <div className="mt-12 mx-4 md:mx-0">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500/70 line-through">Price: ${product.price}</p>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={() => {
                            addToCart(product._id),
                                navigate('/cart')
                        }} className="w-full py-3.5 cursor-pointer font-medium bg-primary/80 text-white hover:bg-primary transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className='flex items-center justify-center md:my-12 my-6 '>
                    <button onClick={() => { navigate('/all-product'), scrollTo(0, 0) }} className='cursor-pointer px-12 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>See more</button>
                </div>
            </div>
        </div>
    );
